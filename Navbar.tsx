...
import { Sparkles, Menu, X, BookOpen, User, Info, ShieldCheck, PlusCircle, LogIn, LogOut, Heart, School, Smile } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          {/* Calm Mode, Sign In, & Mobile Menu Toggle */}
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-[#E8EEF8] border border-[#99AFD7]/40 text-[#344D76] hover:text-[#213554] hover:bg-[#DCE5F4] transition-all focus:ring-2 focus:ring-[#99AFD7]"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-3 border-t border-[#99AFD7]/20 space-y-1.5 bg-white/95 backdrop-blur-md rounded-b-2xl px-2 shadow-md animate-in slide-in-from-top-2 duration-200">
            {currentUser ? (
